...
import { HeadingWS, ButtonWS, npcDialogBackground } from '../../config/grommetConfig';
...
const EstablishmentInterestResolutionDialog: FC<EstablishmentInterestResolutionDialogProps> = ({
  ...
  // -------------------------------------------------- Component state ---------------------------------------------------- //
  const [interests, setInterests] = useState<Interests>({ wantsInOnIt, oweForIt, wantsItGone });
      ...
      <Box gap="12px">
        ...
        <Box fill="horizontal" direction="row" justify="end" gap="small">
          <ButtonWS
            label="RESOLVE"
            primary
            onClick={() => !resolvingInterest && getIsReady() && handleResolve()}
